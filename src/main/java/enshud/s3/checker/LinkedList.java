...
public class LinkedList {
	...
	//ノードの追加
	public void addNode(String name, String name_type, String data_type) {
	...
	//配列ノードの追加
	public void addArrNode(String name, String name_type, String data_type, int array_min,int array_max) {
		Variable_table node = new Variable_table();
		node.name= name;
		node.name_type = name_type;
		node.data_type = data_type;
